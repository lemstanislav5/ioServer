...
module.exports = {
    init: () => {
        ...
        .then(() => query('data.db3', 'all', 'INSERT OR REPLACE INTO setingsColorsUser (id, conteiner, top, messeges, fromId, text, notification, toId) values ("1", "#fff", "#fff", "#000", "#303245", "#000", "#333", "#5e785e")', []))
